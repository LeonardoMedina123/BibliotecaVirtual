...
<head>
    ...
    <title>Panel Admin - Editar Categoría</title>
...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <main class="max-w-2xl mx-auto px-6 py-8">
        <h1 class="text-3xl font-bold text-slate-900 mb-6">Editar Categoría</h1>
        ...
        <form action="{{ route('admin.categorias.update', $categoria->id_categorias) }}" method="POST" class="bg-white rounded-lg shadow p-8">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <input type="url" name="imagen" id="imagen" value="{{ old('imagen', $categoria->imagen) }}" 
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                @if($categoria->imagen)
                    <div class="mt-4">
                        ...
                        <img src="{{ $categoria->imagen }}" alt="{{ $categoria->nombre }}" class="w-32 h-32 object-cover rounded">
                    </div>
                @endif
            </div>
